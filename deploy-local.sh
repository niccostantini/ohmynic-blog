...
ssh root@64.225.70.212 "cd /root/ohmynic-blog && git pull && npm install --omit=dev --prefer-offline && npm run db:migrate; pm2 reload ecosystem.config.cjs --update-env"
